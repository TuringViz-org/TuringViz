...
import { CONTROL_HEIGHT } from '@components/shared/configGraphConstants';
import type { ElkOptions } from '@mytypes/graphTypes';
import { ConfigNodeMode } from '@utils/constants';

export type GraphLayoutSettingsPanelProps = {
  open: boolean;
  onClose: () => void;
  value: ElkOptions;
 ...
 */
export function GraphLayoutSettingsPanel({
  open,
  onClose,
  value,
  onChange,
